...
Organization
Organization
"Separation" "Centralism" "Commonism"
0
...
"" ""
PENS
"happy" 1.0 0 -1184463 true "" "plot count turtles with [color = yellow]"
"sad" 1.0 0 -13345367 true "" "plot count turtles with [color = blue]"
"angry" 1.0 0 -2674135 true "" "plot count turtles with [color = red]"
"scared" 1.0 0 -5825686 true "" "plot count turtles with [color = magenta]"
...
223
606
*How far the houses notice the garbage around
8
0.0
1
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [color = blue or color = red or color = magenta]"
...
1265
169
*Efficency of the garbage collection
8
0.0
1
...
1266
332
*How far neighbors know about the condition of the others
8
0.0
1
...
1452
330
*How invested are the neighbors in  cleaning
8
0.0
1
...
@#$#@#$#@
## Description of the Agents and the Model

The model defines a neighborhood of 20 houses (the agents), which can be Angry, Happy, Sad or Scared. 

These emotions are defined by two factors, the amount of garbage and money. 

Angry agents have large amounts of money and have large amounts of garbage around them; happy agents have little garbage and a lot of money; scared agents have little money and little garbage; and sad agents have little money and a lot of garbage. 

In order to solve their problems, the agents have various modes of organization, including "Separation", "Centralism" and "Commonism". 

The first one a percentage of the residents' money and the garbage collection is adapted to such percentage, that is, the higher the amount of the resident's money, the higher the garbage collection near him. 

Centralism gets an equal percentage of money from all residents, but uses a different strategy: it collects the same amount of garbage throughout the neighborhood. 

And finally, Commonism aims at a community option, it removes money from the equation and generates a community mode in which nearby neighbors in a similar condition support each other, generating mutual benefit. 


(Explain more about the money, etc.)
@#$#@#$#@
default
true
0
